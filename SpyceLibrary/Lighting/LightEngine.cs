...
namespace SpyceLibrary.Lighting
{
    ...
    public class LightEngine : IDrawn
    {
        ...
        public void RegisterSource(LightSource source)
        {
        ...
        public void UnregisterSource(GameObject obj)
        {
            sources.Remove(obj);
        }
        ...
        public void DrawLightSources()
        {
            foreach (LightSource source in sources.Values)
            {
                ...
                spriteBatch.Draw(lightMask, lightRect, null, Color.White * source.Intensity, 0f,
